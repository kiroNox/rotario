					...
					<main class="main-content">
						...
						<div class="container-fluid">
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="nav-primas_generales" role="tabpanel" aria-labelledby="nav-primas_generales-tab">
			...
			if (!$.fn.DataTable.isDataTable("#table_primas_hijos")) {
				$("#table_primas_hijos").DataTable({
					...
					createdRow: function(row,data){
						...
						var acciones = row.querySelector("td:nth-child(5)");
						acciones.innerHTML = '';
						var btn = crearElem("button", "class,btn btn-warning,data-action,modificar", "<span class='bi bi-pencil-square' title='Asignar Sueldo'></span>")
						acciones.appendChild(btn);
						btn = crearElem("button", "class,btn btn-danger ml-1,data-action,eliminar", "<span class='bi bi-trash' title='Eliminar Sueldo'></span>")
						acciones.appendChild(btn);
						acciones.classList.add('text-nowrap','cell-action');
