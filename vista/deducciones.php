				...
				<div class="container-fluid">                                                      
					...
					<script>
						...
						document.getElementById('f1').onsubmit=function(e){
							...
							eventoKeyup("deducciones_meses", /^[0-9]$/, "Solo se permiten números sin espacios");
							eventoKeyup("deducciones_semanas", /^[0-9]$/, "Solo se permiten números sin espacios");
							...
							for(var el of document.querySelectorAll("#f1 input")){
							...
							muestraMensaje("¿Seguro?", "¿ESta seguro de registra la nueva deducción?", "?", function(resul){
								if(resul){
