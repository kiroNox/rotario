...
class AusenciasDetallesPermisosTest extends TestCase
{
    ...
    /**
     * @dataProvider obtenerDetallesPermisosProvider
     */
    public function testObtenerDetallesPermisos($id_trabajador, $expected_result, $caso)
    {
        $resp = $this->administrarEmpleados->obtener_detalles_permisos($id_trabajador);
    ...
    public function obtenerDetallesPermisosProvider()
    {
        return [
