...
class AusenciasDetallesRepososTest extends TestCase
{
    ...
    /**
     * @dataProvider obtenerDetallesRepososProvider
     */
    public function testObtenerDetallesReposos($id_trabajador, $expected_result, $caso)
    {
        $resp = $this->administrarEmpleados->obtener_detalles_reposo($id_trabajador);
    ...
    public function obtenerDetallesRepososProvider()
    {
        return [
